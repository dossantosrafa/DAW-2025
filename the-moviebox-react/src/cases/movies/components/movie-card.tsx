...
export function MovieCard({
    ...
    return(
        <div className="bg-color[#222] rounded-lg shadow-md overflow-hidden
        cursour-pointer hover:shadow-xl hover:translate-y-1 transition">
            <img 
                className="w-full h-[300px] object-cover"
                src={movie.image} alt="Lilo & Stitch" />
